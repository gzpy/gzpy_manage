	...
	<table class="table" width="80%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="50" align="center">电子邮箱</th>	
				<th width="200" align="center">登录账号</th>				
				<th width="200" align="center">登录密码</th>				
		...
		<tbody>
			<c:forEach items="${list_user}" var="user" varStatus="idx">
				<tr>
					...
					<td>${user.password}</td>
					<td>
						<a title="删除" target="ajaxTodo" href="${ctx }/user/deleteUser.do?userId=${user.userId}" class="btnDel">删除</a>
						<a title="编辑" target="dialog" href="${ctx}/user/toUpdateUser.do?userId=${user.userId}" mask="true" title="修改用户" width="850" height="530" class="btnEdit">编辑</a>
						<a title="查看详情" target="dialog" href="${ctx}/user/toUserDetail.do?userId=${user.userId}" mask="true" title="查看详情" width="850" height="530" class="btnView">查看详情</a>
					</td>
				</tr>
			</c:forEach>
